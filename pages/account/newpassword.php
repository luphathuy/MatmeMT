...
<body style="background-image: url('https://anhdepfree.com/wp-content/uploads/2020/04/hinh-nen-khu-rung-toi-tam.jpg'); background-size: cover; margin-top: 100px;">
  <form action="login" class="mx-md-auto p-3 pt-4 pb-5 shadow-lg w-25 shadow border bg-gradient bg-black row">
    ...
    <div class="align-items-md-center col-md-12 d-flex justify-content-center">
      <input class="col-md-12 text-black p-2 rounded-1 border" type="text" name="newpassword" placeholder="Nhập mật khẩu mới" required>
    </div>
    <div class="col-md-12">
      <button class="btn btn-success w-100 mt-3" id="submitButton" type="submitButton" formaction="./newpassword.php" name="submit">Thay Đổi</button>
      <a class="btn btn-success w-100 mt-2 mb-2" href="./forgot.php"><i class="fas fa-angle-left"></i> Trở Lại</a>
    </div>
  </form>
</body>
